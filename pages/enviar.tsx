        ...
        <div className="flex flex-col gap-4 w-full max-w-7xl p-4  border-t-2 border-white">
          <section className="grid md:grid-cols-12 py-8 gap-8 ">
            <div className="md:col-span-4">
              ...
              <div className='mt-3 p-2 px-4 bg-white rounded-lg border border-gray-300'><input className="" type="text" placeholder="Auxiliar Administrativo" name="" id="" /></div>
            </div>

            <div className="md:col-span-4">
              <span className="text-blue-500 font-bold text-lg">CIDADE</span>
              <div className='mt-3 p-2 px-4 bg-white rounded-lg border border-gray-300'><input className="" type="text"  placeholder="Serra" name="" id="" /></div>
            </div>

            <div className="md:col-span-4">
              <span className="text-blue-500 font-bold text-lg">TIPO DE VAGA</span>
              <div className='mt-3 p-2 px-4 bg-white rounded-lg border border-gray-300'><input className="" type="text"  placeholder="Efetivo" name="" id="" /></div>
            </div>
